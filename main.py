...
class Application(Tk):
    def __init__(self):
        ...
        self.numeric_keys_frame.columnconfigure(0, minsize=133)
        self.numeric_keys_frame.columnconfigure(1, minsize=133)
        self.numeric_keys_frame.columnconfigure(2, minsize=133)

        self.operation_keys_frame.columnconfigure(0, minsize=133)
        self.operation_keys_frame.columnconfigure(1, minsize=133)
        self.operation_keys_frame.columnconfigure(2, minsize=133)
